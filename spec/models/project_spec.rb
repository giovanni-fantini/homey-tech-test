...
RSpec.describe Project, type: :model do
  ...
  describe '#interaction_history' do
    ...
    let(:expected_interaction_history) { [first_comment, first_status_change, second_comment, second_status_change] }
    ...
    it 'returns comments and status changes for the project in order of time' do
